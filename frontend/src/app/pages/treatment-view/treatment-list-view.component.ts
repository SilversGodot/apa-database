...
@Component({
  ...
  styleUrls: ['./treatment-list-view.component.css']
})
export class TreatmentListViewComponent implements OnInit {
  dataSource: MatTableDataSource<ITreatmentViewModel>;
  columnsToDisplay = ['name', 'masterPoints', 'primaryPoints', 'supplementalPoints', 'action'];
